<template>
 <div class="abouthotel relative px-2 py-6 content-center flex flex-col flex-wrap abouthotel-text translate-y-0 md:translate-y-[-50%]">
  <div class="flex flex-col flex-wrap justify-center text-amber-950">
   ...
   <p class="text-base md:text-lg lg:text-xl font-normal text-left pb-3">
   Our hotel is in New York City with an outstanding view of the city and surrounding area. Nestled between most of the famous sites and museums.
   </p>
   <p class="text-base md:text-lg lg:text-xl font-normal text-left pb-3">
